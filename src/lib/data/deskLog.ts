 ...
 * 2026-05-14. 70 rows kept (23 D + 47 P) from 93 status rows:
 *  - 10 excluded as C/CO (HEMMINGER, BAXTER, SHTYKA, KINCH, MUIR,
 *    BHANDAL, PEZZOTTI, JEFFERY, GAMBLIN, MALOLOS)
 *  - 1 excluded for ETA > 2026-06-01 (ERIC / LALONDE — ETA 2026-06-02)
...
export const DESK_LOG_DEALS: DeskLogDeal[] = [
  ...
  { date: "2026-04-13", status: "D", source: "UP", rdr: "LM", eta: "", vehicleType: "NEW", salesperson: "SUMIT", split: "ROBERT", customer: "BEDI", vehicle: "PALISADE" },
  { date: "2026-04-17", status: "P", source: "PH", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "DOUG", split: "SUMIT", customer: "BEARDY", vehicle: "PALISADE" },
  { date: "2026-04-20", status: "D", source: "RF", rdr: "LM", eta: "", vehicleType: "NEW", salesperson: "ROBERT", split: "", customer: "FETTERLY", vehicle: "KONA" },
  ...
  { date: "2026-04-25", status: "D", source: "RP", rdr: "LM", eta: "", vehicleType: "NEW", salesperson: "SUMIT", split: "", customer: "KUROCHKIN", vehicle: "ELANTRA HEV" },
  { date: "2026-04-25", status: "P", source: "PH", rdr: "", eta: "2026-05-20", vehicleType: "NEW", salesperson: "BRADY", split: "SUMIT", customer: "BOLT", vehicle: "SANTA FE HEV" },
  ...
  { date: "2026-05-02", status: "D", source: "RP", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "BILL", split: "", customer: "PFEIL", vehicle: "TUCSON" },
  { date: "2026-05-02", status: "D", source: "PH", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "BRADY", split: "SUMIT", customer: "SVEINSON", vehicle: "TUCSON" },
  ...
  { date: "2026-05-02", status: "D", source: "RF", rdr: "", eta: "", vehicleType: "USED", salesperson: "SONNY", split: "", customer: "WARREN", vehicle: "KONA" },
  { date: "2026-05-04", status: "P", source: "RF", rdr: "", eta: "", vehicleType: "NEW", salesperson: "ERIC", split: "", customer: "KAY", vehicle: "KONA" },
  { date: "2026-05-04", status: "D", source: "UP", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "ROBERT", split: "", customer: "SINGH", vehicle: "SONATA HEV" },
  ...
  { date: "2026-05-04", status: "D", source: "UP", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "ERIC", split: "", customer: "KAUR", vehicle: "ELANTRA HEV" },
  { date: "2026-05-05", status: "D", source: "RR", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "VLAD", split: "", customer: "RAND", vehicle: "TUCSON HEV" },
  { date: "2026-05-05", status: "P", source: "UP", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "ROBERT", split: "", customer: "KATUSIME", vehicle: "TUCSON" },
  { date: "2026-05-05", status: "P", source: "PH", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "BRADY", split: "", customer: "GALLAGE", vehicle: "ELANTRA" },
  { date: "2026-05-05", status: "P", source: "UP", rdr: "", eta: "", vehicleType: "NEW", salesperson: "BRADY", split: "ERIC", customer: "HUTLIN", vehicle: "TUCSON" },
  { date: "2026-05-05", status: "P", source: "UP", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "BRADY", split: "", customer: "PANG", vehicle: "ELANTRA" },
  ...
  { date: "2026-05-08", status: "P", source: "RP", rdr: "", eta: "2026-05-20", vehicleType: "NEW", salesperson: "ROBERT", split: "", customer: "DOW", vehicle: "TUCSON PHEV" },
  ...
  { date: "2026-05-09", status: "D", source: "RF", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "VLAD", split: "BRADY", customer: "VICTOR", vehicle: "KONA" },
  { date: "2026-05-09", status: "P", source: "UP", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "DOUG", split: "", customer: "GARGE", vehicle: "ELANTRA" },
  ...
  { date: "2026-05-09", status: "P", source: "RR", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "ERIC", split: "", customer: "VANCAEYZEEL", vehicle: "IONIQ 5" },
  { date: "2026-05-09", status: "D", source: "RP", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "SUMIT", split: "", customer: "HENDERSON", vehicle: "TUCSON HEV" },
  { date: "2026-05-09", status: "P", source: "RP", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "DOUG", split: "BRADY", customer: "ALADENIJII", vehicle: "TUCSON" },
  { date: "2026-05-09", status: "D", source: "UP", rdr: "", eta: "", vehicleType: "USED", salesperson: "VLAD", split: "", customer: "CARREIRO", vehicle: "TUCSON" },
  { date: "2026-05-09", status: "P", source: "RP", rdr: "", eta: "", vehicleType: "NEW", salesperson: "VLAD", split: "", customer: "BUCKNER", vehicle: "SANTA FE HEV" },
  { date: "2026-05-11", status: "P", source: "UP", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "VLAD", split: "", customer: "MACKEY", vehicle: "KONA" },
  { date: "2026-05-11", status: "P", source: "RF", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "SONNY", split: "", customer: "DELA CRUZ", vehicle: "TUCSON HEV" },
  { date: "2026-05-11", status: "P", source: "RF", rdr: "", eta: "", vehicleType: "NEW", salesperson: "SONNY", split: "", customer: "MARQUEZ", vehicle: "TUCSON HEV" },
  { date: "2026-05-12", status: "P", source: "RR", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "ERIC", split: "", customer: "PARKER", vehicle: "TUCSON HEV" },
  { date: "2026-05-12", status: "P", source: "UP", rdr: "R", eta: "", vehicleType: "NEW", salesperson: "SUMIT", split: "DOUG", customer: "LIWAG", vehicle: "TUCSON HEV" },
  { date: "2026-05-12", status: "D", source: "RP", rdr: "", eta: "", vehicleType: "USED", salesperson: "ERIC", split: "", customer: "FORSYTH", vehicle: "KONA" },
  { date: "2026-05-13", status: "P", source: "PH", rdr: "", eta: "", vehicleType: "USED", salesperson: "BRADY", split: "", customer: "ALISON", vehicle: "SANTA FE" },
  { date: "2026-05-15", status: "P", source: "UP", rdr: "P", eta: "", vehicleType: "NEW", salesperson: "ERIC", split: "", customer: "BASSETT", vehicle: "SONATA" },
  ...
  { date: "2026-05-16", status: "P", source: "RR", rdr: "", eta: "", vehicleType: "USED", salesperson: "VLAD", split: "SUMIT", customer: "MACDONALD", vehicle: "KONA" },
  { date: "2026-05-18", status: "P", source: "RP", rdr: "", eta: "", vehicleType: "NEW", salesperson: "BILL", split: "", customer: "NOWOSAD", vehicle: "TUCSON PHEV" },
  { date: "2026-05-18", status: "P", source: "PH", rdr: "", eta: "", vehicleType: "NEW", salesperson: "SONNY", split: "", customer: "SHAKERI JANNATI", vehicle: "TUCSON HEV" },
  { date: "2026-05-18", status: "P", source: "UP", rdr: "", eta: "", vehicleType: "NEW", salesperson: "DOUG", split: "", customer: "PALMQUIST", vehicle: "TUCSON PHEV" },
  { date: "2026-05-18", status: "P", source: "RP", rdr: "", eta: "", vehicleType: "NEW", salesperson: "SUMIT", split: "BRADY", customer: "SIA", vehicle: "VENUE" },
  { date: "2026-05-18", status: "P", source: "PH", rdr: "", eta: "", vehicleType: "NEW", salesperson: "BILL", split: "BRADY", customer: "OSTROVE", vehicle: "TUCSON PHEV" },
  { date: "2026-05-18", status: "P", source: "PH", rdr: "", eta: "", vehicleType: "NEW", salesperson: "BRADY", split: "", customer: "TANG", vehicle: "SANTA FE HEV" },
  { date: "2026-05-19", status: "P", source: "RR", rdr: "", eta: "", vehicleType: "NEW", salesperson: "BILL", split: "", customer: "FERRIS", vehicle: "IONIQ 5" },
];
